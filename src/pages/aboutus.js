    ...
    <div className="relative flex flex-col z-10 min-h-screen h-auto">
      ...
      <body className="relative bg-black h-auto">
        <div className="flex h-auto">
          ...
          <div className="relative right-0 bg-unsplash-[4ZgmCmPXMmI] bg-cover bg-center bg-no-repeat w-1/2 h-auto"></div>
        </div>
        <div className="flex h-auto">
        <div className="relative left-0 bg-unsplash-[F2eHfMwIOxA] bg-cover bg-bottom bg-no-repeat w-1/2 h-auto"></div>
          <h1 className="bg-black w-1/2 h-auto pt-12 text-center text-balance text-white text-6xl font-serif font-bold">
            Our Values
            <p className="paragraph">
        ...
        <div className="flex h-auto">
          ...
          <div className="relative right-0 bg-unsplash-[Zyx1bK9mqmA] bg-cover bg-top bg-no-repeat w-1/2 h-auto"></div>
        </div>
      </body>
    </div>
  );
