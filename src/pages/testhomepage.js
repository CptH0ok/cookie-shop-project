...
const TestHomePage = () => {
  ...
  return (
    <div className="flex flex-col bg-cover bg-center min-h-screen h-auto">
      ...
      <div className="absolute flex sticky top-0 backdrop-blur-md backdrop-contrast-75 pt-4 pb-2 z-20 w-full">
      <div className="flex pl-4">
        ...
        <div className="flex justify-center w-full">
          <img src="https://img.icons8.com/fluency/48/cookies.png" className="ml-5 w-14 h-14"></img>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-32">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className="relative z-10 rounded-md bg-yellow-600 px-3.5 py-2.5 text-base font-serif font-semibold text-white shadow-sm hover:bg-yellow-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Order Now
              </a>
              <a
