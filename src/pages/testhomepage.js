  ...
  return (
    <div className="flex flex-col bg-cover bg-center min-h-screen h-auto">
      ...
      <div className="flex pl-4">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" class="size-12 stroke-white hover:stroke-yellow-500 duration-500">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-32">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="text-white relative rounded-full px-3 py-1 z-10 text-base font-serif leading-6 ring-1 ring-white/10 hover:ring-white/20">
              ...
              <a href="#" className="font-semibold font-serif text-yellow-600">
